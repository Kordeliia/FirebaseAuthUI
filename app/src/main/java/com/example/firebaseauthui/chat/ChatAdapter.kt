...
import com.example.firebaseauthui.databinding.ItemChatBinding
...
class ChatAdapter (private val messageList : MutableList<Message>,
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        var textColor = ContextCompat.getColor(context, R.color.pink_light)
        ...
        if(!message.isSentByMe()){
            ...
            textColor = ContextCompat.getColor(context, R.color.blue_light)
